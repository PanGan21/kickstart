...
beforeEach(async () => {
  ...
  const addresses = await factory.methods.getDeployedCampains().call();
...
describe("Campaigns", () => {
  it("deploys a factory and a campaign contract", async () => {
  ...
  it("processes request", async () => {
    ...
    // use 104 because balance is not reseted after the previous tests
    assert(balance > 104);
  });
});
